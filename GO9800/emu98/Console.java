...
public class Console extends JDialog implements ActionListener
{
  ...
  private JPanel getJContentPane()
  {
    if (jContentPane == null)
    {
      ...
      columnLabels.setText("A       B       E IO   mcisKDPMCS      PC      OPCODE  INSTR           AR1                     AR2");
  ...
  private JTextArea getDisassemblerOutput()
  {
    ...
    {
      disassemblerOutput = new JTextArea();
      disassemblerOutput.setFont(new Font("Monospaced", Font.PLAIN, 12));
      disassemblerOutput.setForeground(Color.blue);
      disassemblerOutput.setBackground(new Color(230, 230, 230));
    }
  ...
  {
    int lines = disassemblerOutput.getLineCount();
    int num = 0;
    ...
    if(lines > MAX_LINES) {
      ...
      try
      {
        num = disassemblerOutput.getLineEndOffset(0);
      } catch (BadLocationException e) {
        e.printStackTrace();
      }
      
      disassemblerOutput.replaceRange(null, 0, num);
    }
    
    disassemblerOutput.append(line);
  ...
  public void clear()
  {
    ...
    try
    {
      num = disassemblerOutput.getLineEndOffset(lines - 1);
    } catch (BadLocationException e) {
      e.printStackTrace();
    }
