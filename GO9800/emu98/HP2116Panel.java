...
public class HP2116Panel extends Frame implements KeyListener, Runnable
{
  ...
  public HP2116Panel(Emulator emu)
  {
    super("HP9800 Panel");
  ...
  public void run()
  {
    while(true) {
      ...
      previous1 = drawRegister(0, Memory.registerT, previous1);
      previous2 = drawRegister(1, emu.registerP.value, previous2);
      previous3 = drawRegister(2, Memory.registerM, previous3);
      previous4 = drawRegister(3, emu.registerA.value, previous4);
      previous5 = drawRegister(4, emu.registerB.value, previous5);
    }
  }
