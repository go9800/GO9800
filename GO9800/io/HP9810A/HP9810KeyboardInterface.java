 ...
 * 09.01.2009 Rel. 1.33 Added synchronized(ioReg){} and ioReg.notifyAll() in requestInterrupt() 
 */
...
public class HP9810KeyboardInterface extends IOinterface implements KeyboardInterface
{
  ...
  public HP9810KeyboardInterface(int selectCode)
  {
    super(selectCode);
