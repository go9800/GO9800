    ...
    public class HP9865A extends IOdevice
    {
      ...
      public int executeCommand()
      {
        ...
        try {
          ...
          if((tapeCommand & REVERSE) != 0) {
            ...
            if(pos < 0) {
              if(debug)
                IOinterface.ioReg.console.append("HP9865A Begin of tape\n");
          ...
          if((tapeCommand & WRITE) != 0) {
            ...
            IOinterface.ioReg.CEO = false;
            
            if(debug)
              IOinterface.ioReg.console.append("HP9865A write " + pos + ": " + Integer.toHexString(ioByte) + "\n");
            
          } else { // READ

            ioByte = tapeFile.readShort();
            if(debug)
              IOinterface.ioReg.console.append("HP9865A  read " + pos + ": " + Integer.toHexString(ioByte) + "\n");
          ...
          if(debug)
            IOinterface.ioReg.console.append("HP9865A End of tape\n");
      ...
      public void stopTape()
      {
        ...
        //debug = IOinterface.ioReg.console.getDebugMode();
        if(debug)
          IOinterface.ioReg.console.append("HP9865A Stop\n");
      ...
      public void output(int status)
      {
        //debug = IOinterface.ioReg.console.getDebugMode();
        if(debug)
          IOinterface.ioReg.console.append("HP9865A Commmand: " + Integer.toHexString(status >> 8) + "\n");
