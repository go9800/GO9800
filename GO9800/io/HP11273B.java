...
public class HP11273B extends IOinterface
{
  ...
  public HP11273B(Integer selectCode, HP9800Mainframe hp9800Mainframe)
  {
    // create thread
    super(selectCode, "HP11273B", hp9800Mainframe);
  ...
  public boolean output()
  {
    ...
    synchronized(ioUnit) {
      ...
      if(ioUnit.CEO) {
        if(debug)
          ioUnit.console.append("HP11273B out: " + Integer.toHexString(ioUnit.getValue()) + "\n");
      ...
      /*
        // asynchronous execution of disc command  -> NOT USED AT THE MOMENT
  ...
  public boolean input()
  {
    ...
    synchronized(ioUnit) {
      if(ioUnit.CEO) {
        ...
        if(debug)
          ioUnit.console.append("HP11273B in: " + Integer.toHexString(ioUnit.bus.din) + "\n");
      } else {
        // put status on IO bus
        ioUnit.bus.din = status;
      }
