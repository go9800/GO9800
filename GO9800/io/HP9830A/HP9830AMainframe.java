...
public class HP9830AMainframe extends HP9800Mainframe
{
  ...
  public HP9830AMainframe(Emulator emu, String machine)
  {
    ...
    ioReg.bus.cardReader = new HP9800BeeperInterface(this);

    // create display
    ioReg.bus.display = new HP9830DisplayInterface(this);

    // create keyboard
    ioReg.bus.keyboard = new HP9830KeyboardInterface(12);
  ...
  public void display(int line, int i)
  {
    ...
    if(ioReg.DEN && backgroundImage && g != null) {
      int[][] displayBuffer = ioReg.bus.display.getDisplayBuffer();
      int x = getInsets().left;
      int y = getInsets().top;
